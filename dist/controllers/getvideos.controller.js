...
exports.getVideos = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, dbConnect_1.default)();
    const videos = yield video_model_1.Video.find();
    return res.status(200).json(new ApiResponse_1.ApiResponse(200, videos, "Videos fetched successfully"));
}));
